const App = (() => {
  const ROLE_TILES = {
    ...
    qmr:        ['quality','ipc','fqc','calibration','ncr','capa','complaints','traceability'],
    supervisor: ['workorders','machines','today','ipc','fqc','traceability'],
  ...
  const SVG = {
    ...
    ipc:         `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>`,
    fqc:         `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="9 11 12 14 22 4"/></svg>`,
  ...
  const TILE_CONFIG = {
    ...
    ipc:          { labelKey: 'home.tile.ipc' },
    fqc:          { labelKey: 'home.tile.fqc' }
  };
  ...
  const ALL_MODULES = [
    ...
    { id: 'ipc',         label: 'In-Process Check',    href: 'ipc.html',         roles: ['director','qmr','supervisor'] },
    { id: 'fqc',         label: 'Final QC & Release',  href: 'fqc.html',         roles: ['director','qmr','supervisor'] },
